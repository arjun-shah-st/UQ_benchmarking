...
class BasePlotter:
    ...
    def generate_plots(self, iteration, x, x_new, y_mean, y_lower, y_upper, y_exact, y_new_exact, **plot_kwargs):
        """
        ...
        for plot in self.plots:
            ...
            y_df = pd.DataFrame(np.c_[y_mean, y_upper - y_lower])
            ...
            y_df.columns = [y_variable_name + " Predictions",
