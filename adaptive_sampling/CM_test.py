...
deep_ens = DeepEnsembleRegressor(n_estimators=5, hidden_sizes=[256, 256], epochs=1500, learning_rate=0.008, batch_size=64) 
...
sampler = BADGESampler("adaptive_sampling/CD_5D/DE_GRUBS", deep_ens, NFGenerator(qoi="CD"), bounds, 10, 75, init_inputs, init_targets, test_inputs, test_targets, plotter=plotter, random_seed=1089384)
...
#k_fold_cqr = KFoldCQR(n_estimators=5, hidden_sizes=[256, 256], epochs=1450, learning_rate=0.0035, batch_size=64)

plotter = BasePlotter("adaptive_sampling/CL_5D/DE_GRUBS", plotting_interval=1)
sampler = BADGESampler("adaptive_sampling/CL_5D/DE_GRUBS", deep_ens, NFGenerator(qoi="CL"), bounds, 10, 75, init_inputs, init_targets, test_inputs, test_targets, plotter=plotter, random_seed=1089384)
...
#k_fold_cqr = KFoldCQR(n_estimators=5, hidden_sizes=[256, 256], epochs=750, learning_rate=0.003, batch_size=64)
deep_ens = DeepEnsembleRegressor(n_estimators=5, hidden_sizes=[256, 256], epochs=750, learning_rate=0.003, batch_size=64) 

plotter = BasePlotter("adaptive_sampling/CM_5D/DE_GRUBS", plotting_interval=1)
sampler = BADGESampler("adaptive_sampling/CM_5D/DE_GRUBS", deep_ens, NFGenerator(qoi="CM"), bounds, 10, 75, init_inputs, init_targets, test_inputs, test_targets, plotter=plotter, random_seed=1089384)
